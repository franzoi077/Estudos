...
public class PrimeiroScan {
    public static void main(String[] args) {
        Scanner leitor = new Scanner(System.in); // é o scanner para ler a entrada do usuário
        ...
        leitor.close(); // fecha o scanner para liberar os recursos associados a ele (boa prática de programação, mas não é estritamente necessário neste caso, pois o programa termina logo em seguida)
    }
}
